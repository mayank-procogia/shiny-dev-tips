...
![](data/logo_lightbulb.png){.absolute bottom="0" right="0" height="175"}
...
-   Slides available at [GitHub Pages](https://github.com/mayank-procogia/shiny-dev-tips){target="_blank"}
