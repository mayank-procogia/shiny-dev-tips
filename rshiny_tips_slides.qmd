...
![](data/logo_lightbulb.png){.absolute bottom="60" right="0" height="175"}
...
-   Quarto presentation code available at [GitHub](https://github.com/mayank-procogia/shiny-dev-tips){target="_blank"}
-   Slides available at [GitHub Pages](https://mayank-procogia.github.io/shiny-dev-tips/rshiny_tips_slides.html){target="_blank"}
